...
const EsgHighlight = () => {
	...
	return (
		<section
			ref={sectionRef}
			className='py-32 bg-gradient-to-br from-base-dark to-black text-white relative overflow-hidden'
		>
			{/* Decorative elements */}
			...
			<div className='container mx-auto px-6 relative z-10'>
				...
				>
					...
					<p className='text-lg mb-10 font-light'>
						Britannia integrates transparent governance, social
						responsibility, and environmental considerations into
						our business practices. Sustainability principles are
						reflected in all our business decisions and advisory
						services.
					</p>
