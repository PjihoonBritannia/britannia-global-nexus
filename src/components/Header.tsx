...
const Header = () => {
  ...
  // Modified logo with better sizing and dynamic color
  const BritanniaLogo = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="140" height="40" viewBox="0 0 2573 686" className="transition-colors duration-300">
      <defs>
    ...
    <header className={`fixed w-full z-50 transition-all duration-300 ${
      ...
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-12">
          ...
          <Button 
            className={`${isScrolled ? 'bg-point hover:bg-point/90' : 'bg-white text-point hover:bg-white/90'} text-white rounded-[35px] hover:shadow-lg transition-shadow duration-300`}
          >
            Contact Us
          </Button>
        </nav>
        ...
        {/* Mobile Menu Button */}
        <button
          className={`md:hidden p-2 ${isScrolled ? 'text-base-dark' : 'text-white'}`}
          onClick={toggleMenu}
