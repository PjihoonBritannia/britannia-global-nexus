...
const BusinessAreas = () => {
	...
	const services = [
		{
			...
			description:
				'전략적 투자 및 포트폴리오 관리를 통한 장기적 가치 창출. 한국 자본을 기반으로 글로벌 시장에서의 안정적인 성장 추구.',
			icon: <Globe size={32} />,
			link: '/about#holding',
		},
		{
			...
			description:
				'유럽, 중동 및 아프리카 지역 M&A 전문성 보유. Target Identification, Deal Sourcing, Due Diligence 등 종합적 자문 서비스 제공.',
		...
		},
		{
			...
			description:
				'기업 전략 수립, PMI(인수 후 통합), 운영 효율성 및 가치 창출 계획 수립을 통한 지속 가능한 비즈니스 모델 구축.',
			icon: <Users size={32} />,
	...
	return (
		<section
			ref={sectionRef}
			className='py-32 bg-gray-50 min-h-[800px] flex items-center'
		>
			<div className='container mx-auto px-4'>
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-10 mb-16 mt-8'>
					<AnimatedCounter
						value={150}
						suffix='+'
						title='Successful M&A Deals'
					/>
					<AnimatedCounter
						value={25}
						suffix='+'
						title='Countries with Active Projects'
					/>
					<AnimatedCounter
						value={98}
						suffix='%'
