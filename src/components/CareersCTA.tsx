      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-5">
            <Button asChild className="bg-white text-gray-900 hover:bg-gray-100 hover-lift">
              <Link to="/careers" className="inline-flex items-center">
                View Career Opportunities
                <ArrowUpRight size={16} className="ml-2" />
              </Link>
            </Button>
            <Button variant="outline" className="bg-transparent text-white border-white hover:bg-white/10 hover-lift">
              <Link to="/careers#life" className="inline-flex items-center">
                Life at Britannia
