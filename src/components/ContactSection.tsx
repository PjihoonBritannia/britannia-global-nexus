...
const ContactSection = () => {
	...
	return (
		<section id='contact' className='py-32 md:py-36 lg:py-40'>
					...
					<div className='space-y-12 bg-white rounded-[35px] p-10 shadow-sm'>
						<div>
							...
							<div className='space-y-8'>
								<div className='flex gap-4 items-start'>
									...
									<div>
										<h4 className='text-point font-medium mb-2'>
											Seoul HQ
										</h4>
										<address className='not-italic text-gray-600 font-light space-y-1'>
											...
											<p>
												Yeongdeungpo-gu, Seoul, Republic
												of Korea
											</p>
											<p className='mt-2'>
												Tel: +82 2-419-8244
								...
								<div className='flex gap-4 items-start'>
									...
									<div>
										...
										<address className='not-italic text-gray-600 font-light space-y-1'>
											...
											<p>
												London, WC1A 2NN, United Kingdom
											</p>
											<p className='mt-2'>
												Tel: +44 20-7183-9321
											</p>
						...
						<div>
							...
							<div className='text-gray-600 font-light'>
								...
								<p className='mt-4 italic text-point'>
