            ...
            <Tabs defaultValue="news" className="w-full">
              <div className="flex justify-center mb-8">
                <TabsList className="grid w-full max-w-md grid-cols-3">
                  <TabsTrigger value="news">뉴스 및 공지</TabsTrigger>
                    ...
                    <div key={item.id} className="bg-white rounded-lg shadow-md overflow-hidden">
                      ...
                      <div className="p-6">
                        <div className="flex items-center text-sm text-corporate-dark-gray mb-3">
                          <span className="bg-corporate-light-gray px-2 py-1 rounded-md">{item.category}</span>
                        ...
                        <Link to={`/media/news/${item.id}`} className="text-corporate-blue font-medium hover:text-corporate-teal">
                          자세히 보기
                        </Link>
                      </div>
                    </div>
                  ...
                  {insights.map((item) => (
                    <div key={item.id} className="bg-white rounded-lg shadow-md overflow-hidden flex flex-col md:flex-row">
                      ...
                      <div className="md:w-2/3 p-6">
                        ...
                        <Link to={`/media/insights/${item.id}`} className="text-corporate-blue font-medium hover:text-corporate-teal">
                          자세히 보기
                        </Link>
                      </div>
                    </div>
                    ...
                    <div key={item.id} className="bg-white rounded-lg shadow-md overflow-hidden group relative">
                      ...
                      <div className="p-6">
                        <div className="flex items-center justify-between text-sm text-corporate-dark-gray mb-3">
                          <span className="bg-corporate-light-gray px-2 py-1 rounded-md">{item.type}</span>
                          {item.duration && (
