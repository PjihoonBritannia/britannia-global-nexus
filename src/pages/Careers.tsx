...
const Careers = () => {
  const benefits = [
    {
      title: "글로벌 경험",
      description: "국경을 초월한 M&A 거래와 자문 프로젝트를 통한 국제적 경험",
    },
    {
      title: "지속적 성장",
      description: "지속적인 학습과 전문성 개발을 위한 체계적인 교육 프로그램",
    },
    {
      title: "멘토링 기회",
    ...
    {
      title: "글로벌 네트워크",
      description: "다양한 국적의 전문가들과 협업하며 글로벌 네트워크 구축",
    },
  ];
  ...
  const applicationSteps = [
    {
      step: "1",
      title: "서류 지원",
      description: "이력서, 자기소개서, 성적증명서 등 필요 서류를 온라인으로 제출",
    },
    {
      step: "2",
      title: "서류 심사",
    ...
    },
    {
      step: "3",
      title: "온라인 평가",
      description: "직무 관련 지식, 분석 능력, 영어 능력 등을 평가하는 온라인 테스트",
    },
    {
      step: "4",
      title: "1차 면접",
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-3xl mx-auto mb-12">
              <div className="bg-corporate-light-gray p-8 rounded-lg">
                ...
                <p className="text-corporate-dark-gray">
                  브리타니아는 한국 자본을 기반으로 EMEA 시장을 연결하는 글로벌 M&A 및 경영 자문 전문 기업입니다. 우리와 함께라면 국경을 초월한 거래 경험, 다양한 문화와 비즈니스 환경에 대한 이해, 그리고 글로벌 금융 전문가로서의 성장 기회를 얻을 수 있습니다.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {benefits.map((benefit) => (
                <div key={benefit.title} className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
        ...
        <section className="py-16 bg-corporate-light-gray" id="life">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-xl font-semibold text-corporate-navy mb-4">우리의 기업 문화</h3>
                <p className="text-corporate-dark-gray mb-6">
                  브리타니아는 성과 지향적이면서도 협력적인 문화를 추구합니다. 우리는 서로의 다양한 배경과 관점을 존중하며, 열린 소통을 통해 최선의 결과를 도출합니다. 수평적인 조직 문화 속에서 모든 구성원이 자유롭게 아이디어를 제안하고 토론할 수 있습니다.
                </p>
                
                <h3 className="text-xl font-semibold text-corporate-navy mb-4">성장과 발전</h3>
                <p className="text-corporate-dark-gray mb-6">
                  우리는 모든 직원의 지속적인 성장을 지원합니다. 정기적인 교육 프로그램, 글로벌 컨퍼런스 참여 기회, 직무 순환 제도 등을 통해 다양한 경험과 지식을 쌓을 수 있는 환경을 제공합니다.
                </p>
                
                <h3 className="text-xl font-semibold text-corporate-navy mb-4">일과 삶의 균형</h3>
                <p className="text-corporate-dark-gray">
                  브리타니아는 직원들의 일과 삶의 균형을 중시합니다. 유연 근무제, 재택 근무 옵션, 가족 친화적 정책 등을 통해 직원들이 일과 개인 생활을 조화롭게 유지할 수 있도록 지원합니다.
                </p>
              </div>
              
              <div className="space-y-6">
                {testimonials.map((testimonial) => (
                  <div key={testimonial.name} className="bg-white p-6 rounded-lg shadow-sm flex">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-corporate-navy">{testimonial.name}</p>
                      <p className="text-sm text-corporate-blue">{testimonial.position}</p>
                    </div>
                  </div>
                ))}
              </div>
          ...
          <div className="container mx-auto px-4">
                  ...
                  <AccordionItem value={`item-${index}`} className="border rounded-lg overflow-hidden">
                    <AccordionTrigger className="px-6 py-4 hover:no-underline hover:bg-corporate-light-gray">
                      <div className="flex flex-col md:flex-row md:items-center justify-between w-full text-left">
                        <div className="font-semibold text-lg text-corporate-navy">{job.title}</div>
                    ...
                    <AccordionContent className="px-6 py-4">
                      <div className="space-y-4">
                        <div>
                          <h4 className="font-semibold text-corporate-navy mb-2">주요 자격 요건</h4>
            ...
            <div className="mt-12 text-center">
              <p className="text-corporate-dark-gray mb-4">
                적합한 포지션을 찾지 못하셨나요? 우리는 항상 뛰어난 인재를 찾고 있습니다.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {applicationSteps.map((step) => (
                  <div key={step.step} className="bg-white p-6 rounded-lg shadow-sm">
                    <div className="w-10 h-10 rounded-full bg-corporate-blue text-white flex items-center justify-center font-bold mb-4">
                      {step.step}
                    </div>
                    <h3 className="text-lg font-semibold text-corporate-navy mb-2">{step.title}</h3>
                    <p className="text-corporate-dark-gray">{step.description}</p>
                  </div>
                ))}
              </div>
              
              <div className="bg-white p-8 rounded-lg shadow-sm mt-12">
                <h3 className="text-xl font-semibold text-corporate-navy mb-4">지원 시 필요 서류</h3>
                <ul className="list-disc pl-5 text-corporate-dark-gray space-y-2">
                  <li>이력서 (영문 및 국문)</li>
                  <li>자기소개서 (경력 목표 및 브리타니아에 지원하는 이유 포함)</li>
                  <li>최종 학력 성적증명서</li>
                ...
                <div className="mt-6">
                  <p className="text-corporate-dark-gray mb-4">
                    모든 지원서는 <strong>careers@britannia-inc.com</strong>으로 제출해 주시기 바랍니다.
                  </p>
                  <Button className="bg-corporate-blue hover:bg-corporate-teal">
                    채용 페이지로 이동
                  </Button>
